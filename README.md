...
|:--------------------------------------:|:----------------------------------------------------:|:-----------------------:|--------------------------------------------------------------------------------------------------------------------------|
|              **_issue_**               |     **\<player\><br>\<#points\><br>\[reason\]**      |  emi.par.charter.issue  | Issue a player points with a reason into the tracker                                                                     |
...
|               **_edit_**               | **\<pointID\><br>\<new #points\><br>\[new reason\]** |  emi.par.charter.edit   | Edit a point issue record. Point ID is required for accurate record edit                                                 |
...
|:--------------------------------------:|:-----------------------------------------------------------------------------:|:--------------------------:|---------------------------------------------------------------------------------------------------------------------------------------|
|          **_project create_**          |          **\<project name\><br>\<project lead\><br>\<description\>**          |  emi.mint.project.create   | Initialy creates the project and adds you to the project                                                                              |
...
|           **_material add_**           |              **\<project name\><br>\<material\><br>\<amount\>**               |   emi.mint.material.add    | Lets you add a material to a project. Material is just a string input meaning you can put whatever you want                           |
|         **_material delete_**          |                   **\<project name\><br>\<material name\>**                   |  emi.mint.material.delete  | Lets you delete a material given the name of the material set                                                                         |
|          **_material focus_**          |                   **\<project name\><br>\<material name\>**                   |  emi.mint.material.focus   | Set the material as focused in a project                                                                                              |
|        **_material complete_**         |                   **\<project name\><br>\<material name\>**                   | emi.mint.material.complete | Set the material as complete                                                                                                          |
